...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContentPlaceHolder" runat="server">
    ...
    <asp:ObjectDataSource ID="SlipsByDockObjectDataSource" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetAvailableSlipsByDock" TypeName="Marina_CPRG214_Lab2.App_Code.SlipDB" InsertMethod="LeaseSlip">
        <SelectParameters>
