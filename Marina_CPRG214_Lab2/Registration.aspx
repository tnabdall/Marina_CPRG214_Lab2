...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContentPlaceHolder" runat="server">
    <div class="container">
        ...
        <asp:RequiredFieldValidator ID="firstNameRequiredValidator" CssClass="text-danger" runat="server" ErrorMessage="First Name required. " Enabled="False" Display="Dynamic" ControlToValidate="firstNameTextBox"></asp:RequiredFieldValidator>
            ...
            <asp:RegularExpressionValidator ID="phoneRegularExpressionValidator" CssClass="text-danger" runat="server" ErrorMessage="Phone must follow format: 111-111-1111" ValidationExpression="^[0-9]{3}-[0-9]{3}-[0-9]{4}$" ControlToValidate="phoneTextBox"></asp:RegularExpressionValidator></div>
    </div>
</asp:Content>
